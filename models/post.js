...
module.exports = (sequelize, DataTypes) => {
  class Post extends Model {
    ...
    static async findAllPosts() {
          const [results, metadata] = await sequelize.query("select * from posts join (select id as fid, UserId from freelancers) as f on f.fid = posts.FreelancerId order by adPriority desc;");
          return results;
      }
